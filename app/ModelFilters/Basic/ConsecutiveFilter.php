...
class ConsecutiveFilter extends ModelFilter
{
    ...
    public function createdBy($createdBy){
        return $this->where('consecutive_notice.created_by', 'like', "%$createdBy%");
    }
    ...
    {
        return $this->orderBy('consecutive_notice.created_at', $this->input('dir', 'asc'));
    }
}